...
class ProductService extends ApplicationService{
  ...
  async listCategoryProperties(category_id) {
    return await this.get(`center/category-properties/${category_id}`)
  }

  async getSubCategories(category_id) {
    return await this.get(`center/subcategories?is_paginated=0&type=stores&category=${category_id}`)
  }
