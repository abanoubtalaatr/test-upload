        ...
        <b-form data-vv-scope="profile" @submit.prevent="updateProfile">
            ...
            <b-col md="12">
              ...
              >
                <b-form-input
                  ...
                  v-validate="{ required: true }"
                  :placeholder="$t('admin.center_en_name')"
            ...
            <b-col md="12">
              ...
              >
                <b-form-input
                  ...
                  v-validate="{ required: true }"
                  :placeholder="$t('admin.center_ar_name')"
          ...
          <b-row>
           ...
           <b-row>
            <b-col md="6"></b-col>
            <b-col md="6">
              <a v-if="user.avatar && typeof(user.avatar) == 'string'" :href="user.avatar" target="_blank">
              <b-img
          ...
          <b-row>
            <b-col md="6"></b-col>
            <b-col md="6">
              <a v-if="user.image && typeof(user.image) == 'string'" :href="user.image" target="_blank">
              <b-img
                :lazy-src="user.image"
                :src="user.image"
                max-height="100"
