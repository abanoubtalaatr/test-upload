    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('centers-admins-create')"
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <nuxt-link class="table_icon" :to="localePath(`/centers/admins/${el.item.id}/edit`)" v-show="permissions.includes('admins.update') && !el.item.is_super_admin"
