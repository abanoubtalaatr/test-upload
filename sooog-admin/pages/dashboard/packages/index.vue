    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('dashboard-packages-create')"
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <span class="table_icon mr-2" @click.prevent="handleToggleStatus(el.item.id)" v-show="permissions.includes('packages.update')"
            ...
            <nuxt-link class="table_icon" :to="localePath(`/dashboard/packages/${el.item.id}/edit`)" v-show="permissions.includes('packages.update')"
              ><i class="far fa-edit"></i
            ></nuxt-link>

            <span v-if="!el.item.is_free" class="table_icon mr-2" @click="trashModal(el.item.id)" v-show="permissions.includes('packages.delete')"
