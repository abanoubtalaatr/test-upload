...
export default {
    async asyncData (context){
        ...
        let response = await context.$axios.$get("/admin/stores?is_paginated=1&type=stores&status=accepted").catch((e) => { console.log('err: ', e) })
        return {
    ...
    methods: {
        ...
        */
        ...
        exportToExcel(){
            StoreService.excelExport(`?type=stores&status=accepted&public_search=${this.publicSearch}`)
            .then(response => {
          ...
          forceFileDownload(response){
            ...
            link.href = url
            link.setAttribute('download', 'current_stores.xlsx') //or any other extension
