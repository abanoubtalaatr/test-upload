...
export default {
    async asyncData (context){
        let response = await context.$axios.$get("/admin/refund-reasons?is_paginated=1").catch((e) => { console.log('err: ', e) })
        return {
    ...
    data () {
        return {
            ...
            customEvents: [
                ...
                { eventName: 'event-delete-refund-reason', callback: this.handleDelete }
            ],
    ...
    methods: {
        ...
        */
        ...
        await RefundReasonService.getAll(this.queryParam)
            .then((response) => {
        ...
        */
        ...
        await RefundReasonService.destroy(id)
            .then(() => {
            //* remove this row *//
        ...
        RefundReasonService.toggleStatus(id)
            .then((response) => {
            //* update list *//
    ...
    computed: {
        titleStack () {
            return [this.$t('admin.refund_reasons')]
        }
    },
    head () {
        return {
