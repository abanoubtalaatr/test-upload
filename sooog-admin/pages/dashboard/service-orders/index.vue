      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <nuxt-link class="table_icon" :to="localePath(`/dashboard/service-orders/${el.item.id}`)"
              ><i class="far fa-eye"></i
            ></nuxt-link>

            <nuxt-link class="table_icon" :to="localePath(`/dashboard/service-orders/${el.item.id}/edit`)" v-show="permissions.includes('orders.update')"
