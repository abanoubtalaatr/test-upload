    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('dashboard-promo-codes-create')"
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <span class="table_icon mr-2" @click.prevent="handleToggleStatus(el.item.id)" v-show="permissions.includes('promo_codes.update')"
            ...
            <nuxt-link class="table_icon" :to="localePath(`/dashboard/promo-codes/${el.item.id}/edit`)" v-show="permissions.includes('promo_codes.update')"
              ><i class="far fa-edit"></i
            ></nuxt-link>

            <span class="table_icon mr-2" @click="trashModal(el.item.id)" v-show="permissions.includes('promo_codes.delete')"
