...
import FilterModal from '~/pages/dashboard/services/-filter/-index.vue'
...
export default {
    ...
    async asyncData (context){
        try {
            let response = await context.$axios.$get("/admin/products?type=centers&is_paginated=1&is_detailed=1")
            return {
