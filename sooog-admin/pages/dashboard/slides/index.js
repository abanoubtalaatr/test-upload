...
export default {
    async asyncData (context){
        try {
            let response = await context.$axios.$get("/admin/slides?is_paginated=1&is_detailed=1")
            return {
    ...
    data () {
        return {
            ...
            customEvents: [
                ...
                { eventName: 'event-delete-ad', callback: this.handleDelete }
            ],
    ...
    methods: {
        ...
        */
        ...
        AdService.getAll(this.queryParam)
            .then((response) => {
