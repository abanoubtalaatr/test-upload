...
export default {
    async asyncData (context){
        ...
        let response = await context.$axios.$get("/admin/subcategories?is_paginated=1&is_detailed=1&type=stores").catch((e) => { console.log('err: ', e) })
    ...
    data () {
        return {
            ...
            customEvents: [
                ...
                { eventName: 'event-delete-category', callback: this.handleDelete }
            ],
    ...
    methods: {
        ...
        */
        ...
        this.queryParam = `?page=${this.meta.current_page}&is_paginated=1&is_detailed=1&type=stores&public_search=${this.publicSearch}&orderBy=${this.orderBy}&orderType=${this.orderType}`

        await CategoryService.getAllSubcategories(this.queryParam)
            .then((response) => {
