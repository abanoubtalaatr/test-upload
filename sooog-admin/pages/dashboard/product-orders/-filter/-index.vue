            ...
            <card-component :title="titlePage" icon="fas fa-clipboard-list 5x">
                <b-form @submit.prevent="submit">
                    ...
                    <b-row>
                        ...
                        <b-form-group
                            :label="type == 'centers' ? $t('admin.maintenance_center') : $t('admin.store')"
                            label-for="input-horizontal"
                            id="fieldset-horizontal"
                            label-cols-sm="2"
                        >
                            ...
                            :placeholder="type == 'centers' ? $t('admin.maintenance_center') : $t('admin.store')"
                            label="key"
                            :allowEmpty="true"
                    ...
                    <b-row>
                        <b-col md="12" v-if="payment_methods">
                        <b-form-group
