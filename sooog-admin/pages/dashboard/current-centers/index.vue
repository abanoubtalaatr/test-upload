    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('dashboard-current-centers-featured')"
            class="btn btn-success"
            v-show="permissions.includes('centers.featured')"
          >
            <i class="fas fa-diamond"></i>
            {{ $t("admin.set_featured_centers") }}
          </nuxt-link>
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <span class="table_icon mr-2" @click.prevent="handleToggleStatus(el.item)" v-show="permissions.includes('centers.update')"
            ...
            <nuxt-link class="table_icon" :to="localePath(`/dashboard/current-centers/${el.item.id}`)"
              ><i class="far fa-eye"></i
            ></nuxt-link>

            <nuxt-link class="table_icon" :to="localePath(`/dashboard/current-centers/${el.item.id}/edit`)" v-show="permissions.includes('centers.update')"
