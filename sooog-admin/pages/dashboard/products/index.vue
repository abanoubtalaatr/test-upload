    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('dashboard-products-create')"
            class="btn btn-success"
            v-show="permissions.includes('products.create')"
          >
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <span class="table_icon mr-2" @click.prevent="handleToggleStatus(el.item.id)" v-show="permissions.includes('products.update')"
            ...
            <nuxt-link class="table_icon" :to="localePath(`/dashboard/products/${el.item.id}/edit`)" v-show="permissions.includes('products.update')"
              ><i class="far fa-edit"></i
            ></nuxt-link>

            <span class="table_icon mr-2" @click="trashModal(el.item.id)" v-show="permissions.includes('products.delete')"
