...
import OrderProducts from '~/pages/stores/product-orders/-form/-OrderProducts/-index.vue'
import StoreService from '~/pages/stores/product-orders/-service/-StoreService'
import UserService from '~/pages/stores/product-orders/-service/-UserService'
export default {
  layout: 'store',
  components: {
    OrderProducts
    ...
    methods: {
      ...
      back () {
        this.$router.push(this.localePath({ name: "stores-product-orders" }))
      }
    },
  }
