      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <nuxt-link class="table_icon" :to="localePath(`/stores/product-orders/${el.item.id}`)"
              ><i class="far fa-eye"></i
            ></nuxt-link>

            <nuxt-link class="table_icon" v-if="el.item.status.key == 'new'" :to="localePath(`/stores/product-orders/${el.item.id}/edit`)" v-show="permissions.includes('orders.update')"
              ><i class="far fa-edit"></i
            ></nuxt-link>
            <nuxt-link :title="$t('admin.refund')" class="table_icon" v-if="el.item.status.key == 'delivered'" :to="localePath(`/stores/product-orders/${el.item.id}/refund`)" v-show="permissions.includes('refunds.create')"
