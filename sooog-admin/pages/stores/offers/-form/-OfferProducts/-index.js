import ProductService from '@/pages/stores/offers/-service/-ProductService'
...
export default {
  components: {
    ...
    //fetchOnServer: true,
    created () {
      console.log('store', this.storeData.store_id)
      this.loadAsyncData()
    ...
    methods: {
        ...
        */
        ...
        this.queryParam = `?page=${this.current_page}&type=stores&store=${this.storeData.store_id}&is_paginated=1&is_detailed=1&public_search=${this.publicSearch}`
