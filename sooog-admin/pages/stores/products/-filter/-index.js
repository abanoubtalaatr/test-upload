import ProductService from "~/pages/stores/products/-service/-ProductService";
    ...
    methods: {
      async loadData() {
        ...
        const response = await Promise.all([
          this.$axios.$get(`/store/categories?type=stores`),
          this.$axios.$get(`/store/brands?type=stores`)
        ])
