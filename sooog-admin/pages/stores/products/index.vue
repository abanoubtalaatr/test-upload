    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('stores-products-create')"
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <nuxt-link class="table_icon" :to="localePath(`/stores/products/${el.item.id}/edit`)" v-show="permissions.includes('products.update')"
