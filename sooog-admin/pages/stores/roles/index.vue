    ...
    <div class="countries">
      <div class="level">
        <div class="level-left">
          <nuxt-link :to="localePath('stores-roles-create')"
      ...
      <div class="table_wrap">
        ...
        >
          ...
          <template v-slot:cell(action)="el">
            ...
            <nuxt-link class="table_icon" :to="localePath(`/stores/roles/${el.item.id}/edit`)" v-show="permissions.includes('roles.update')"
