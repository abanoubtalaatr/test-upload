...
use App\Location\Domain\Models\CountryTranslation;
    ...
    public function run()
    {
        ...
        foreach ($countries as $country)
        {
           $country_obj = Country::create([
               'id' => $country['id'],
               'is_active' => $country['iso2'] == 'SA' ? 1 : 0,
               'code' => $country['iso2'],
               'ar'  => ['name' => $country['name']],
               'en'  => ['name' => $country['name']],
           ]);
       }
       ...
       //     ]);
       // $countriesData = Country::where('code', '!=', 'SA')->get();
