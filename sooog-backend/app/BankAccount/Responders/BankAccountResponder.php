...
namespace App\BankAccount\Responders;

use App\Infrastructure\Responders\Responder;
use App\BankAccount\Domain\Resources\BankAccountResource;
use App\BankAccount\Domain\Resources\BankAccountLiteResource;
use App\Infrastructure\Helpers\Traits\RESTApi;
use App\Infrastructure\Helpers\Traits\ApiPaginator;
use Symfony\Component\HttpFoundation\Response;

class BankAccountResponder extends Responder
{
    ...
    public function respond()
    {
        ...
        if($this->response->getStatus() == Response::HTTP_CREATED)
            return $this->sendJson(
                new BankAccountResource($this->response->getData()),
                Response::HTTP_OK
            );

        if($this->response->getStatus() == Response::HTTP_OK)
            return $this->sendJson(
                BankAccountLiteResource::collection($this->response->getData()),
