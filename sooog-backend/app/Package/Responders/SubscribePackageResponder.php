...
class SubscribePackageResponder extends Responder
{
    ...
    public function respond()
    {
        ...
        if($this->response->getStatus() == Response::HTTP_CREATED)
            return $this->sendJson(
                new StorePackageResource($this->response->getData()),
                Response::HTTP_OK
            );

        if($this->response->getStatus() == Response::HTTP_OK)
            return $this->sendJson(
                StorePackageLiteResource::collection($this->response->getData()),
